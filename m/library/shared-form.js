...
var autocomplete_callback_p=function(items){ $("#F__ID input[name=Participant_uid]").val(items["UID"]);$("#F__ID input[name=baseline]").val(items["bl"]); }
...
//--------------------------
    if(m.input!=undefined && m.input.participant_record!=undefined){
        ...
        $("#F__ID input[name=baseline]").val(m.input.participant_record.I3);
    }
